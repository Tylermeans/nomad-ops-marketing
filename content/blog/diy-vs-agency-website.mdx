...
**Performance.** Website builders add layers of code you can't control. A typical Squarespace site scores between 30–60 on Google's PageSpeed test for mobile. A custom-built site using modern frameworks routinely scores 90+. That gap isn't academic — [Google uses page speed as a ranking factor](https://developers.google.com/search/docs/appearance/page-experience), and visitors feel the difference. A site that loads in 1.5 seconds feels snappy. A site that loads in 5 seconds feels broken.
...
- [Schema markup](https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data) (structured data that helps Google understand your content)
